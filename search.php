		...
		<div class="row">
	      <form action="search.php">
			  <div class="form-group">
			  	<div class="col-xs-5">
			    	<input type="text" class="form-control" id="search" name="keywords" value="<?php echo $_GET['keywords'];?>">
			    </div>
			    <div class="col-xs-1">
...
<?php
	...
	$sql = "select student.id, student.name, student.age, class.classname from student join class on student.classid=class.id where name like '%$keywords%' ";
